...
export async function authRoutes(fastify: FastifyInstance): Promise<void> {
     ...
     * - First login: creates professor + syncs groups through backend-apirest
     * - Same period: returns JWT without sync
     * - New period: syncs groups through backend-apirest
     */
     ...
     * Force sync groups for a professor through backend-apirest
