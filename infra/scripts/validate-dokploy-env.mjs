...
const SECRET_FIELDS = [
  ...
  'ACADEMIC_DB_PASSWORD', 'ATTENDANCE_SERVICE_DB_PASSWORD', 'COORDINATION_QUERY_DB_PASSWORD', 'APP_LOG_DB_PASSWORD',
  ...
  'ACADEMIC_METRICS_TOKEN', 'ATTENDANCE_METRICS_TOKEN', 'COORDINATION_QUERY_METRICS_TOKEN', 'APP_LOG_METRICS_TOKEN',
  'BINDING_JWT_SECRET', 'ATTENDANCE_JOB_ENCRYPTION_SECRET', 'UAT_SESSION_ENCRYPTION_SECRET',
  'APP_LOG_INGESTION_KEY', 'DEMO_SESSION_SECRET',
];

const URL_FIELDS = [
  'ATTENDANCE_DATABASE_URL', 'UAT_DATABASE_URL', 'IDENTITY_DATABASE_URL', 'ACADEMIC_DATABASE_URL',
  'ATTENDANCE_SERVICE_DATABASE_URL', 'COORDINATION_QUERY_DATABASE_URL', 'APP_LOG_DATABASE_URL', 'REDIS_URL', 'RABBITMQ_URL',
];
