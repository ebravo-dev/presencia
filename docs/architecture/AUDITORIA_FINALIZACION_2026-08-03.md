...
| Microservicios y datos separados | Gateway, Identity, Academic, Attendance, UAT Integration y Coordination Query usan límites y bases lógicas propios. Identity posee cuentas/sesiones del personal; Academic posee clases compartidas y publica permisos revocables; Attendance posee beacons, dispositivos y telemetría BLE con migraciones auditables. | Núcleo, administración y clases compartidas implementados; las sustituciones temporales antiguas y fachadas móviles conservan compatibilidad hasta un corte observado. |
