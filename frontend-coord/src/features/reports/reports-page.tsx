...
export function ReportsPage() {
  ...
  const exportExcel = async () => { if (data) await (await import('./excel-exporter')).exportReportExcel(data); };
  const exportPdf = async () => { if (data) (await import('./pdf-exporter')).exportReportPdf(data); };
