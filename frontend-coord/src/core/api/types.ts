...
export interface ReportRow {
  ...
  cells: Record<ReportDay, ReportCell>;
}
export interface WeeklyReportResponse {
  data: {
    availability: 'READY' | 'NOT_SYNCED' | 'IDENTITY_UNAVAILABLE';
    teacher: { id: string; name: string; email: string | null; institutionalCode: string | null; coordinations: Array<{ id: string; externalId: string; name: string }> };
